                ...
                <div class="col-xl-4 col-xxl-6 col-sm-6">
                    <div class="card coin-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num">$2,478</h2>
                                <span class="text-white fs-18">Total Sells</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-xxl-6 col-sm-6">
                    <div class="card bg-info invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num">165</h2>
                                <span class="text-white fs-18">Daily Visitors</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card bg-secondary invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                ...
                                <span class="text-white fs-18">Contact Messages</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-12 col-xxl-12">
                    <div class="card">
                        <div class="card-header pb-0 border-0">
                            <div>
                                <h4 class="card-title mb-2">Most Sold Item</h4>
